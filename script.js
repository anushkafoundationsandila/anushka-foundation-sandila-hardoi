...
// Scroll down karne par menu/header upar hide hoga, scroll up/top par wapas show hoga.
(function(){
    'use strict';
    ...
    function updateHeader(){
        ...
        const menuOpen = navMenu && navMenu.classList.contains('show');

        if(currentScroll <= 20 || currentScroll < lastScroll || menuOpen){
